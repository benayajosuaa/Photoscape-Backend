...
export declare function refreshController(req: Request): Promise<Response>;
...
export declare function refreshExpressController(req: ExpressRequest, res: ExpressResponse): Promise<void>;
