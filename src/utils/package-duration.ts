...
export function inferPackageTypeFromName(name: string): PackageType | null {
...
export function getEffectivePackageDurationMinutes(photoPackage: { name: string; durationMinutes: number }) {
