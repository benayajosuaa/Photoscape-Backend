...
export const OwnerAdminController = {
  ...
  async setCustomerBlacklist(req: Request, res: Response) {
    try {
      const id = single(req.params.id)?.trim() || '';
  ...
  async getReportsRevenue(req: Request, res: Response) {
    try {
  ...
  async getReportsBookings(req: Request, res: Response) {
    try {
  ...
  async getReportsStudioUsage(req: Request, res: Response) {
    try {
  ...
  async blockSchedule(req: Request, res: Response) {
    try {
  ...
  async unblockSchedule(req: Request, res: Response) {
    try {
  ...
  async updateOperationalHours(req: Request, res: Response) {
    try {
